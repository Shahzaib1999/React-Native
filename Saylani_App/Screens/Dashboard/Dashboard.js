...
import { MapView, Permissions, Location, ImagePicker } from 'expo';
            ...
            {!loading ?
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.second}>
                        ...
                        <TextInput placeholder="Enter Name" onChangeText={val => this.onChangeText('name', val)} value={name} style={styles.input} />
                    </View>
                    <View style={styles.second}>
